...
<body>
    <div class="container">
        ...
        <p class="info"><strong>Kasir:</strong> <?= $petugas ? $petugas->nm_petugas : 'Umum' ?></p>
        ...
        <p class="summary"><strong>Poin Didapatkan:</strong> <span class="right"><?= number_format($transaksi['poin_didapat'], 0, ',', '.') ?></span></p>
    </div>
